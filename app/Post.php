...
class Post extends Model {
  ...
  public static function getEventData($eventId, $profile) {
    if (! Post::where('fb_post_id', '=', $eventId)->first()) {
      ...
      try {
        $response = $client->request('GET', 'https://graph.facebook.com/v2.8/753848861413032?access_token=EAACiMDeoXMsBANBXH7vXQtKwt6jnpFCdT21XPuWz0edf8PiEvhR81bN1IZB8ZBoRZCaLIDb7mIIu3efq91AFO29HTmVzWvxlgqpOD9yrSnC0p23UUUgv86MOSggcsuQ6VEvvcScxZBQHkq4tMWdgtbdAOfomVxcqD8tsI8SWGwZDZD');
