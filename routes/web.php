...
use App\Http\Middleware\Pusher;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::prefix('api/web')->group(function () {
	...
	Route::get('posts/subscriptions/instagram', 'Api\Web\PostsController@verifyInstagram');
...
Route::get('test', 'ProfilesController@test')->name('profiles.test');
