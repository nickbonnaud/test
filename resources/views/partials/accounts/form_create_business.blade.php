<form method="POST" action="{{ route('accounts.update', ['accounts' => $account->slug]) }}">
  ...
  <input type="hidden" name="type" value="business">
    ...
    <input type="text" name="legal_biz_name" id="legal_biz_name" value="{{ $account->legal_biz_name }}" placeholder="Example, Inc." class="form-control" required>
	</div>
	<div class="form-group">
    ...
    <input type="text" name="biz_street_address" id="biz_street_address" value="{{ $account->biz_street_address }}" class="form-control" required>
	</div>
	<div class="form-group">
    <label for="biz_city">City</label>
    <input type="text" name="biz_city" id="biz_city" value="{{ $account->biz_city }}" class="form-control" required>
	</div>
	<div class="form-group">
